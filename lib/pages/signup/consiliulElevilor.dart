...
class CElevSignup extends StatefulWidget {
  const CElevSignup({Key? key}) : super(key: key);

  @override
  _CElevSignupState createState() => _CElevSignupState();
}

final FirebaseMessaging _firebaseMessaging = FirebaseMessaging.instance;

class _CElevSignupState extends State<CElevSignup> {
  bool firstPage = true;
              ...
              TextButton(
                onPressed: () async {
                  if (_formKey.currentState!.validate()) {
                    ...
                    var url = Uri.parse(
                        '${Misc.link}/${Misc.appName}/register_c_elev.php');
