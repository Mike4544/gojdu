...
import 'package:gojdu/pages/signup/consiliulElevilor.dart';
            ...
            children: [
              ...
              SizedBox(
                ...
                child: TextButton(
                  onPressed: () {
                    Navigator.push(
                        context, SlideRightRoute(page: StudentSignUp()));
                  },
                  child: const Text(
                    'Student',
                    style: TextStyle(
              ...
              SizedBox(
                ...
                child: TextButton(
                  onPressed: () {
                    Navigator.push(
                        context, SlideRightRoute(page: ParentsSignupPage1()));
                  },
                  child: const Text(
                    'Parent',
                    style: TextStyle(
              ...
              SizedBox(
                ...
                child: TextButton(
                  onPressed: () {
                    Navigator.push(
                        context, SlideRightRoute(page: TeacherSignUp()));
                  },
                  child: const Text(
                    'Teacher',
                    style: TextStyle(
              ...
              SizedBox(
                ...
                child: TextButton(
                  onPressed: () {
                    Navigator.push(
                        context, SlideRightRoute(page: AdminSignUp()));
                  },
                  child: const Text(
                    'Admin',
                    style: TextStyle(
              ...
              SizedBox(
                ...
                child: TextButton(
                  onPressed: () {
                    Navigator.push(
                        context, SlideRightRoute(page: CElevSignup()));
                  },
                  child: const Text(
                    'C. Elevilor',
                    style: TextStyle(
